...
public class TreeController extends ActionBarActivity implements NewLeafDialogFragment.LeafDialogListener{
    ...
    public static class LeafFragment extends Fragment {
        ...
        public void onViewCreated(View view, Bundle savedInstanceState) {
            ...
            else if(tree.getTreeImageID() == R.drawable.group_image1)
                getActivity().findViewById(R.id.pager).setBackground(getResources().getDrawable(R.drawable.group_image1));
            else if(tree.getTreeImageID() == R.drawable.group_image2)
                getActivity().findViewById(R.id.pager).setBackground(getResources().getDrawable(R.drawable.group_image2));
            else if(tree.getTreeImageID() == R.drawable.group_image3)
                getActivity().findViewById(R.id.pager).setBackground(getResources().getDrawable(R.drawable.group_image3));
                ...
                public void onClick(View view) {
                    if (!leafs.get(sectionNumber - 1).getMembers().contains(GroveController.user)) {
                        ...
                        getActivity().runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                ((TreeController) getActivity()).mSectionsPagerAdapter.notifyDataSetChanged();
                            }
                        });
                    }
                }
